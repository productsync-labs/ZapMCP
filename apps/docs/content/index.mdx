...
ZapMCP is a local-first framework for building Model Context Protocol (MCP) servers for coding agents. Using these servers, you can provide direct access to the complete knowledge base of your library in Cursor, Windsurf, Cline, or any other IDE that supports MCP.
